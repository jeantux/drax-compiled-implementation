...
typedef enum dlex_types {
  ...
  DTK_OR, DTK_PUTS, DTK_RETURN, 
  DTK_TRUE, DTK_LET,

  /* Types Keywords*/
  DTK_KEY_BOOL, DTK_KEY_INT, DTK_KEY_FLOAT, 
  DTK_KEY_STRING, DTK_KEY_ANY,

  DTK_ID, DTK_STRING, DTK_COMMA, DTK_NUMBER,
  DTK_DOT, DTK_COLON, DTK_DBCOLON,
